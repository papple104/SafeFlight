package com.example.safeflight.Other.History;
...
import com.example.safeflight.Other.History.hisbean.HistoryBean;
...
public class HistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.item_history_timeline,null);
    ...
    class ViewHolder{
        ...
        public ViewHolder(View itemView){
            timeTv=itemView.findViewById(R.id.item_history_time);
            titleTv=itemView.findViewById(R.id.item_history_title);
            picIv=itemView.findViewById(R.id.item_history_pic);
            timeLayout=itemView.findViewById(R.id.item_history_ll);
        }
    }
}
