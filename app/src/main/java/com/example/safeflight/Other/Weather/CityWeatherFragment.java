package com.example.safeflight.Other.Weather;
...
import com.example.safeflight.Other.Weather.base_wea.BaseFragment;
import com.example.safeflight.Other.Weather.WeaBean.WeatherBean;
import com.example.safeflight.Other.Weather.wdb.DBManager;
...
public class CityWeatherFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bundle bundle=getArguments();//获取activity信息的方法，用bundle来传递
        city=bundle.getString("city");//得到城市信息
        String url=url1+city+url2;//得到完整的url
        //调用父类获取数据的方法
        loadData(url);
        return view;
    }
    ...
    private void parseShowData(String result) {
        ...
        for(int i=0;i<futureList.size();i++){
            View itemView=LayoutInflater.from(getActivity()).inflate(R.layout.item_weather_center,null);
    ...
    private void initView(View view){
        ...
        citvTv=view.findViewById(R.id.frag_tv_city);
