...
import com.example.safeflight.Adapter.ManChooseAdapter;
...
import static com.example.safeflight.app.Url.singleSelect;

public class ManChooseActivity extends AppCompatActivity implements View.OnClickListener{
    ImageView shuaxin,sousuo;
    EditText shuru;
    RecyclerView liebiao;
    SingleBean singleBean;
    ManChooseAdapter singleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        singleAdapter = new ManChooseAdapter(this,list);
